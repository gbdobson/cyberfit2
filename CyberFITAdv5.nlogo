...
to go
  ...
  if a1Phase = 7 AND a2Phase = 7 AND a3Phase = 7 [
    ...
    print a1P1TR + a1P2TR + a1P3TR + a1P4TR + a1P5TR + a1P6TR
    print a1TotalTime

    print a2P1TR + a2P2TR + a2P3TR + a2P4TR + a2P5TR + a2P6TR
    print a2TotalTime

    print a3P1TR + a3P2TR + a3P3TR + a3P4TR + a3P5TR + a3P6TR
    print a3TotalTime

    file-open "VE2_30.txt"
    file-type a1P1TR
    file-type ","
    file-type a1P2TR
    file-type ","
     ...
     if terType = 1
      [
        ...
        [
          ...
          [
            if r1 < 14 [ if comp = 0 AND del = 0 [ set vul 1 set color yellow ] ]
          ]
        ]
      ]
      if terType = 2
      [
        ...
        [
          ...
          if environment = "tactical"
          [
            if s1 < 27 [ if comp = 0 AND del = 0 [ set vul 1 set color yellow ] ]
          ]
          if environment = "industrial"
          [
            if s1 < 14 [ if comp = 0 AND del = 0 [set vul 1 set color yellow ] ]
          ]
        ]
      ]
      if terType = 3
      [
        ...
        [
          ...
          if environment = "base"
          [
            if t1 < 59 [ if comp = 0 AND del = 0 [ set vul 1 set color yellow ] ]
          ]
          if environment = "tactical"
          [
            if t1 < 30 [ if comp = 0 AND del = 0 [ set vul 1 set color yellow ] ]
          ]
          if environment = "industrial"
          [
...
to attacker1Phase2
  ...
  if o1 < successProb [
     ...
     set a1TotalTime a1TotalTime + a1PhaseTime
     set a1PhaseTime 0
     ;print "done a1Phase2 Weaponization"
    ]
...
to attacker3Phase4
  ...
  if a3Phase4Expl = 1 [
    ...
    set a3PhaseTime 0
    ;print a3P4TR
    ;print "done a3Phase 4 Exploitation"
    ;print a3Phase
    ]
end
